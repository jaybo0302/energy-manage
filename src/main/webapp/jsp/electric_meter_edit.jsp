...
<div class="pd-20">
  <div class="Huiform">
    <form action="${pageContext.request.contextPath}/electricmeter/editElectricMeter.do" method="post" class="form form-horizontal" id="form-company-edit">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>电表号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="deviceNo" id="deviceNo" value="${electricmeter.deviceNo}" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>电表名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   id="deviceName" name="deviceName" value = "${electricmeter.deviceName}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>串口号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   id="port" name="port" value = "${electricmeter.port}">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>电表位置：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   id="position" name="position" value = "${electricmeter.position}">
			</div>
		</div>
		<div class="row cl">
