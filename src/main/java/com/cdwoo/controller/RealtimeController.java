...
public class RealtimeController {
	...
	@ResponseBody
	@RequestMapping("queryRealtimeByPage")
	public CDResult queryRealtimeByPage(MeterInfoParam param, HttpServletRequest req) {
		...
		return CDResult.success(meterInfoService.queryRealtimeByPage(param));
	}
}
